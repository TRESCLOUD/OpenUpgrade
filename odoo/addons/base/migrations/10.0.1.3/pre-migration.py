...
def migrate(cr, version):
    ...
    openupgrade.update_module_names(
        cr, [
            ...
            ('vat_tax_fourteen_percent_retail','l10n_ec'),
            ('warning','l10n_ec'),
            ('web_m2x_options_extra_lock','l10n_ec'),
            ('web_pdf_preview','l10n_ec'),
            ('web_printscreen_zb','l10n_ec'),
            ('report_custom_filename','l10n_ec'),
            ('purchase_landing_costs','l10n_ec'),
            ('auth_openid','l10n_ec'),
            ('auth_oauth_signup','l10n_ec'),
            ('report_xls_core','l10n_ec'),
            ('trescloud_accumulated_discount','l10n_ec'),
            ('trescloud_infinity_analytic','l10n_ec'),
            ('trescloud_opportunity_related_meeting','l10n_ec'),
